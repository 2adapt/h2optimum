...
$: {
  ...
  <!-- Narrow sidebar -->
  <div class="hidden w-28 overflow-y-auto bg-blue-700 md:block scrollbar-custom">
...
<!-- 
 ...
 -->      
      <div class="Xmt-6 w-full flex-1 space-y-1 px-2">
        ...
        <a href="/testecards/installations" class="group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium
        ...
        <a href="/testecards/users" class="group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium
        ...
        <a href="/testecards/help" class="group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium
