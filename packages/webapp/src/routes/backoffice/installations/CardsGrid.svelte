					...
					<div class="-ml-4 -mt-4 flex flex-nowrap items-center justify-between">
						...
						<div class="relative inline-block text-left">
							...
							>
								...
								<form class="group flex items-center px-4 py-2 text-sm text-gray-700" method="POST" action="{currentPath}?/deleteInstallation">
									<svg
								...
								<button
								type="submit"
								class="group flex items-center px-3 py-2 text-sm text-gray-700"
								>Apagar
								</button>
