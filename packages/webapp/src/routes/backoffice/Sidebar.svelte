...
<!-- 
 ...
 -->      
      <div class="Xmt-6 w-full flex-1 space-y-1 px-2">
        ...
        >
          <svg class="text-blue-100 group-hover:text-white h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    ...
    >
      <!--
        ...
        Leaving: "transition ease-in-out duration-300 transform"
          ...
          To: "-translate-x-full"
      -->
      <div class="relative flex w-full max-w-xs flex-1 flex-col bg-sky-500 Xpt-5 Xpb-4"
      style="display:none;"
      use:cssTransition={{ show: $sidebarIsOpen }}
...
-->
              ...
              {$page.route.id.startsWith('/backoffice/installations') ? 'bg-sky-600 text-white' : 'text-blue-100 hover:bg-sky-400 hover:text-white'}"
              >
                <svg class="text-blue-100 group-hover:text-white mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
                </svg>
