			...
			<li class="flex justify-between gap-x-6 p-5">
				...
				<div  class="sm:flex sm:flex-col sm:items-end relative">
					{#if Object.keys(errorsObj).length > 0}
						...
						<span bind:this="{diagDesc}" class="hidden absolute right-0 p-2 top-7 z-10 w-[70vw] sm:w-[30vw] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none "> </span>
					{:else}
