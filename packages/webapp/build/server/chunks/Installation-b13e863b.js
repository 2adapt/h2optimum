	...
	<div class="h-24 rounded-t-lg border-b border-gray-200 bg-sky-500 px-4 py-5 sm:px-6">
		<div class="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
			...
			<div class="ml-4 mt-2 flex-shrink-0">				
				...
				<input type="text" id="flatPickrTemp" class="h-10 w-60 text-sm text-gray-500"${add_attribute("this", flatContainer, 0)}></div>
		</div>
	</div>
...
//# sourceMappingURL=Installation-b13e863b.js.map
